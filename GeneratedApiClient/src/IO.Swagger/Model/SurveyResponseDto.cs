...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SurveyResponseDto :  IEquatable<SurveyResponseDto>, IValidatableObject
    {
        /// <summary>
        ...
        public SurveyResponseDto(int? id = default(int?), List<AnswerDto> answers = default(List<AnswerDto>), int? surveyId = default(int?))
        {
            this.Id = id;
