...
namespace IO.Swagger.Model
{
        ...
        public partial class Course :  IEquatable<Course>, IValidatableObject
    {
        ...
        public Course(int? id = default(int?), string name = default(string), int? semesterId = default(int?), Semester semester = default(Semester), List<CourseLecturer> courseLecturers = default(List<CourseLecturer>), List<CourseParticipant> courseParticipants = default(List<CourseParticipant>))
        {
            this.Id = id;
            this.Name = name;
        ...
        /// </summary>
        [DataMember(Name="semester", EmitDefaultValue=false)]
        ...
        public bool Equals(Course input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.Semester != null &&
                    this.Semester.Equals(input.Semester))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Semester != null)
                    hashCode = hashCode * 59 + this.Semester.GetHashCode();
