...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Semester :  IEquatable<Semester>, IValidatableObject
    {
        /// <summary>
        ...
        public Semester(int? id = default(int?), string name = default(string), List<Course> courses = default(List<Course>))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as Semester);
        }

        /// <summary>
        /// Returns true if Semester instances are equal
        /// </summary>
        /// <param name="input">Instance of Semester to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Semester input)
        {
            if (input == null)
                return false;
